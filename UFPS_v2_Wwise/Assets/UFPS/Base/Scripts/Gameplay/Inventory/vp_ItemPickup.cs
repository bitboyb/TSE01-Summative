...
public class vp_ItemPickup : MonoBehaviour
{
	...
	public class SoundSection
	{
        ...
        public AK.Wwise.Event pickupFailSound;
	...
	*/
	...
	protected virtual void Awake()
	{
        ...
        //post Wwise event
        m_Sound.pickupSound.Post(gameObject);
	...
	protected virtual void OnFail(Transform recipient)
	{
		...
		if (!m_AlreadyFailed && (!vp_Gameplay.IsMultiplayer || (vp_Gameplay.IsMultiplayer && (recipient.GetComponent<vp_FPPlayerEventHandler>() != null))))
		{
            //post Wwise event
            m_Sound.pickupFailSound.Post(gameObject);
        }
