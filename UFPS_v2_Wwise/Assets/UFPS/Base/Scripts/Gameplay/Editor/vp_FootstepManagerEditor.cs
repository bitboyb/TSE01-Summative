			...
			for (int i = 0; i < m_Component.SurfaceTypes.Count; ++i)
			{
				...
				if(surface.Foldout)
				{
					...
					if(surface.SoundsFoldout)
					{
						...
						{
							Debug.LogWarning("TODO - Add Sound has been disabled by Adam B-C because AudioClip constructor has been made inaccesible in Unity 2018.");
							//Todo - We don't need this for Thinkspace as we use Fmod but prob could do with fixing this properly at some point
