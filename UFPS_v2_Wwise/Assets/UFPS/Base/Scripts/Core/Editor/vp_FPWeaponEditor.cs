...
public class vp_FPWeaponEditor : Editor
{
	...
	public virtual void DoSoundFoldout()
	{
		...
		if (m_WeaponSoundFoldout)
		{
            ...
            //SerializedProperty wieldSound = serializedObject.FindProperty("SoundWield");
            //SerializedProperty UnwieldSound = serializedObject.FindProperty("SoundUnWield");
            //EditorGUILayout.PropertyField(wieldSound, true);
            //EditorGUILayout.PropertyField(UnwieldSound, true);

            //Wwise GUI
            SerializedProperty wieldSound = serializedObject.FindProperty("wieldSound");
            SerializedProperty unWieldSound = serializedObject.FindProperty("unwieldSound");
            EditorGUILayout.PropertyField(wieldSound);
            EditorGUILayout.PropertyField(unWieldSound);
