...
public class vp_PlayerFootFXHandler : vp_Component
{
    ...
    GameObject m_AudioLeft = null;
    GameObject AudioLeft
    {
        get
        {
            if (m_AudioLeft == null)
    ...
    GameObject m_AudioRight = null;
    GameObject AudioRight
    {
        get
        {
    ...
    GameObject m_JumpFallAudio = null;
    protected GameObject JumpFallAudio
    {
        get
        {
            if (m_JumpFallAudio == null)
            {
                m_JumpFallAudio = transform.root.gameObject;
        ...
        switch (Mode)
		{
			...
			case (int)FootstepMode.FixedTimeInterval:
				...
				else
				{
                    ...
                    AudioObject = ((AudioLeft != null) ? AudioLeft : AudioRight);
	...
	protected virtual void DoStep()
	{
		...
		if (FootstepImpactEvent != null)
		{
			...
			if (!IsMoving || ((surface == null) || !surface.CanHaveFootprints()))
			{
				...
				vp_SurfaceManager.SpawnEffect(m_Hit, FootstepImpactEvent, AudioObject, surface,  false);
			...
			else
			{
				...
				m_CurrentFoot.transform.forward, m_FlipFootprint, VerifyGroundContact, AudioObject);
