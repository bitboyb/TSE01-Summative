...
public class vp_WeaponShooterEditor : Editor
{
	...
	public virtual void DoSoundFoldout()
	{
		...
		if (m_SoundFoldout)
		{
            ...
            EditorGUILayout.PropertyField(dryFireSound, true);

            //SerializedProperty SoundSwing = serializedObject.FindProperty("SoundSwing");
            //EditorGUILayout.PropertyField(SoundSwing);
