...
public class vp_FPWeaponShooterEditor : Editor
{
	...
	public virtual void DoSoundFoldout()
	{
		...
		if (m_SoundFoldout)
		{
            ...
            //SerializedProperty soundFire = serializedObject.FindProperty("SoundFire");
            //SerializedProperty soundDryFire = serializedObject.FindProperty("SoundDryFire");

            //EditorGUILayout.PropertyField(soundFire, true);
            //EditorGUILayout.PropertyField(soundDryFire, true);
            ...
            SerializedProperty dryFireSound = serializedObject.FindProperty("dryFireSound");
            EditorGUILayout.PropertyField(fireSound);
            EditorGUILayout.PropertyField(dryFireSound);
