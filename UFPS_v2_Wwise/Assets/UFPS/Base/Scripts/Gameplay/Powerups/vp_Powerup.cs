...
public abstract class vp_Powerup : MonoBehaviour
{
	...
	// sounds
    //[FMODUnity.EventRef]
	public string PickupSound;		// player triggers the powerup
    //[FMODUnity.EventRef]
    public string PickupFailSound;	// player failed to pick up the powerup (i.e. ammo full)
    //[FMODUnity.EventRef]
    public string RespawnSound;		// powerup respawns
	...
	protected virtual void OnTriggerEnter(Collider col)
	{
		...
		else if (!m_AlreadyFailed)
		{
			...
			{
                if (PickupFailSound != string.Empty)
                {
                    //FMODUnity.RuntimeManager.PlayOneShotAttached(PickupFailSound, gameObject);
                }
			}
	...
	protected virtual void Respawn()
	{
        ...
        if (RespawnSound != string.Empty)
        {
            //FMODUnity.RuntimeManager.PlayOneShotAttached(RespawnSound, gameObject);
        }
