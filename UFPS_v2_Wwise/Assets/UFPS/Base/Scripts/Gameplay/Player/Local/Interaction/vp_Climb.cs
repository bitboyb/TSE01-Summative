...
public class vp_Climb : vp_Interactable
{
	...
	public class vp_ClimbingSounds{
        //[FMODUnity.EventRef]
		public string MountSounds;
        //[FMODUnity.EventRef]
        public string DismountSounds;
		public float ClimbingSoundSpeed = 4;
        //[FMODUnity.EventRef]
        public string ClimbingSounds;
	}
	...
	/// 
	/// </summary>
	protected virtual void PlaySound( string sounds )
	{
		
		if(sounds == string.Empty)
			return;

        //FMODUnity.RuntimeManager.PlayOneShot(sounds);
	...
	protected virtual void Climbing()
	{
		...
		if (m_Player.InputClimbVector.Get() != 0 && !m_ClimbingSoundTimer.Active)
		{
