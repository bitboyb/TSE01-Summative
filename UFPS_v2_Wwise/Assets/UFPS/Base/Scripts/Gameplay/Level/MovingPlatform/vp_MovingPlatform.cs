...
public class vp_MovingPlatform : MonoBehaviour
{
	...
	protected void OnStart()
	{
		...
		if (SoundStart != string.Empty)
		{
            //FMODUnity.RuntimeManager.PlayOneShotAttached(SoundStart, gameObject);
    ...
    {
        if (SoundWaypoint != string.Empty)
        {
            //FMODUnity.RuntimeManager.PlayOneShotAttached(SoundWaypoint, gameObject);
        }
    }
	...
	protected void OnStop()
	{
        ...
        if (SoundStop != string.Empty)
        {
            //FMODUnity.RuntimeManager.PlayOneShotAttached(SoundStop, gameObject);
        }
