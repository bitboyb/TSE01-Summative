...
public class vp_SurfaceManager : MonoBehaviour
{
	...
	/// </summary>
	public static bool SpawnEffect(RaycastHit hit, vp_ImpactEvent impact, GameObject audioSource = null, vp_SurfaceType surface = null, bool allowDecal = true)
	{
	...
	/// </summary>
	public static bool SpawnEffect(RaycastHit hit, GameObject audioSource, vp_ImpactEvent impactEvent, bool allowDecal = true)
	{
		return SpawnEffect(hit, audioSource, impactEvent, allowDecal);
	}
	...
	/// ground contact
	/// </summary>
	public static void SpawnFootprintEffect(RaycastHit hit, vp_SurfaceType surface, vp_ImpactEvent impactEvent, Vector3 footprintDirection, bool footprintFlip, bool footprintVerifyGroundContact = false, GameObject audioSource = null, bool allowDecal = true)
	{
		...
		SpawnEffect(hit, impactEvent, audioSource, surface,  allowDecal);
	...
	/// will be inverted
	/// </summary>
	public static void SpawnFootprintEffect(RaycastHit hit, vp_ImpactEvent impactEvent, Vector3 footprintDirection, bool footprintFlip, bool footprintVerifyGroundContact = false, GameObject audioSource = null, bool allowDecal = true)
	{
